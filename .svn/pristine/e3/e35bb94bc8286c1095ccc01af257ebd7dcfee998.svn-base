...
(function(window) {
    ...
    GLOBAL.p2Keys = {
        ...
        Interact: Crafty.keys.PERIOD,
        Inventory: Crafty.keys.COMMA
    };
    GLOBAL.firstLevel = true;
    GLOBAL.currentLevel; // Check gameScene.js to set starting level.
    ...
    GLOBAL.evilOnLeft;
    // TODO: Make these non-global at some point.
...
function intersect(x1, y1, x2, y2, obj){
    ...
    if (x1 < obj.x + objW && x1 > obj.x && y1 < obj.y + objW && y1 > obj.y){
        return false;
    }
