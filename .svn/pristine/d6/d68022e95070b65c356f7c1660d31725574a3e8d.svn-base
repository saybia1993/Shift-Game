...
Crafty.extend({
	 ...
	 * Due to the nature of HTML5 soundeffects, three types of soundeffects files will be
	...
	audio : {
		...
		codecs : {// Chart from jPlayer
			ogg : 'soundeffects/ogg; codecs="vorbis"', //OGG
			wav : 'soundeffects/wav; codecs="1"', // PCM
			webma : 'soundeffects/webm; codecs="vorbis"', // WEBM
			mp3 : 'soundeffects/mpeg; codecs="mp3"', //MP3
			m4a : 'soundeffects/mp4; codecs="mp4a.40.2"'// AAC / MP4
		},
		...
		audioElement : function() {
			...
			return typeof Audio !== 'undefined' ? new Audio("") : document.createElement('soundeffects');
		},
		/**@
		 * #Crafty.soundeffects.add
		 * @comp Crafty.soundeffects
		 * @sign public this Crafty.soundeffects.add(String id, String url)
		 * @param id - A string to refer to sounds
		 * @param url - A string pointing to the sound file
		 * @sign public this Crafty.soundeffects.add(String id, Array urls)
		 * @param urls - Array of urls pointing to different format of the same sound, selecting the first that is playable
		 * @sign public this Crafty.soundeffects.add(Object map)
		 * @param map - key-value pairs where the key is the `id` and the value is either a `url` or `urls`
		 *
		 * Loads a sound to be played. Due to the nature of HTML5 soundeffects,
		 * three types of soundeffects files will be required for cross-browser capabilities.
		 ...
		 *
		 * Accepts an object where the key is the soundeffects name and
		 * either a URL or an Array of URLs (to determine which type to use).
		 *
		 * The ID you use will be how you refer to that sound when using `Crafty.soundeffects.play`.
		 *
		 * @example
		 * ~~~
		 * //adding soundeffects from an object
		 * Crafty.soundeffects.add({
		 ...
		 *
		 * //only one format
		 * Crafty.soundeffects.add("jump", "sounds/jump.mp3");
		 * ~~~
		 */
		add : function(id, url) {
			Crafty.support.audio = !!this.audioElement().canPlayType;
			//Setup soundeffects support
		...
		/**@
		 * #Crafty.soundeffects.play
		 * @comp Crafty.soundeffects
		 * @sign public this Crafty.soundeffects.play(String id)
		 * @sign public this Crafty.soundeffects.play(String id, Number repeatCount)
		 * @sign public this Crafty.soundeffects.play(String id, Number repeatCount,Number volume)
		 * @param id - A string to refer to sounds
		 ...
		 *
		 * Will play a sound previously added by using the ID that was used in `Crafty.soundeffects.add`.
		 ...
		 * @example
		 * ~~~
		 * Crafty.soundeffects.play("walk");
		 *
		 * //play and repeat forever
		 * Crafty.soundeffects.play("backgroundMusic", -1);
		 * Crafty.soundeffects.play("explosion",1,0.5); //play sound once with volume of 50%
		 * ~~~
		 */
		...
		/**@
		 * #Crafty.soundeffects.stop
		 * @sign public this Crafty.soundeffects.stop([Number ID])
		 *
		...
		/**
		 * #Crafty.soundeffects._mute
		 * @sign public this Crafty.soundeffects._mute([Boolean mute])
		 *
		...
		/**@
		 * #Crafty.soundeffects.toggleMute
		 * @sign public this Crafty.soundeffects.toggleMute()
		 *
		...
		/**@
		 * #Crafty.soundeffects.mute
		 * @sign public this Crafty.soundeffects.mute()
		 *
		...
		/**@
		 * #Crafty.soundeffects.unmute
		 * @sign public this Crafty.soundeffects.unmute()
		 *
		...
		/**@
		 * #Crafty.soundeffects.pause
		 * @sign public this Crafty.soundeffects.pause(string ID)
		 *
		 * Pause the Audio instance specified by id param.
		 *
		 * @example
		 * ~~~
		 * Crafty.soundeffects.pause('music');
		 * ~~~
		 *
		 * @param {string} id The id of the soundeffects object to pause
		 */
		pause : function(id) {
		...
		/**@
		 * #Crafty.soundeffects.unpause
		 * @sign public this Crafty.soundeffects.unpause(string ID)
		 *
		 * Resume playing the Audio instance specified by id param.
		 *
		 * @example
		 * ~~~
		 * Crafty.soundeffects.unpause('music');
		 * ~~~
		 *
		 * @param {string} id The id of the soundeffects object to unpause
		 */
		unpause : function(id) {
			if (!Crafty.support.audio || !id || !this.sounds[id])
				return;
		...
		/**@
		 * #Crafty.soundeffects.togglePause
		 * @sign public this Crafty.soundeffects.togglePause(string ID)
		 *
		 * Toggle the pause status of the Audio instance specified by id param.
		 *
		 * @example
		 * ~~~
		 * Crafty.soundeffects.togglePause('music');
		 * ~~~
		 *
		 * @param {string} id The id of the soundeffects object to pause/unpause
		 */
...
/**@
	...
	*
	* If `Crafty.support.soundeffects` is `true`, files with the following suffixes `mp3`, `wav`, `ogg` and `mp4` (case insensitive) can be loaded.
	*
	...
	*         Crafty.soundeffects.play("jump.mp3"); //Play the soundeffects file
	*     },
	*
	*     function(e) {
	*       //progress
	...
	*/
    load: function (data, oncomplete, onprogress, onerror) {
        ...
        function pro(){
            ...
            //Remove events cause soundeffects trigger this event more than once(depends on browser)
